...
public class MenuController {
    ...
    private static final String ABOUT_URL = "/about.html";

    private static final String HOW_TO_USE_URL = "/howtouse.html";
    private static final String HOW_TO_USE_VIEW = "howtouse";
    
    private static final String UPCOMING_FEATURES_URL = "/upcoming.html";
